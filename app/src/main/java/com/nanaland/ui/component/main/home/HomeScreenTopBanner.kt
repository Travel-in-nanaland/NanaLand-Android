...
import com.nanaland.ui.component.main.home.parts.HomeScreenTopBannerPageIndicator
...
fun HomeScreenTopBanner(
    ...
    onBannerClick: (Long, String?) -> Unit,
) {
    Box {
            ...
            is UiState.Success -> {
                HorizontalPager(state = pagerState) { page ->
                    HomeScreenNanaPickBanner(
                        ...
                        onClick = { onBannerClick(topBanner.data[page % (topBanner.data.size)].id, "NANA") }
                    )
                }
