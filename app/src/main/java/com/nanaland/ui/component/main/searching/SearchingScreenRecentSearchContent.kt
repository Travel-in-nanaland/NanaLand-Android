...
import com.nanaland.ui.component.main.searching.parts.SearchingScreenRecentSearchItem
            ...
            Row(
                ...
                recentSearchList.forEachIndexed { idx, item ->
                    SearchingScreenRecentSearchItem(
                        ...
                        onClick = {
                            searchKeyword(item.second)
                            updateInputText(item.second)
                            addRecentSearch(item.second)
