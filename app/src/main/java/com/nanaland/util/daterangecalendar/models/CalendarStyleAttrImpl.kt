...
import com.nanaland.util.daterangecalendar.models.CalendarStyleAttributes.Companion.DEFAULT_FIXED_DAYS_SELECTION
...
class CalendarStyleAttrImpl(context: Context, attributeSet: AttributeSet? = null) :
    ...
    override var rangeDateColor = ContextCompat.getColor(context, R.color.range_date_color)
        private set
    override var textSizeTitle = 22f
        private set
    override var textSizeWeek = 22f
        private set
    override var textSizeDate = 22f
        private set
