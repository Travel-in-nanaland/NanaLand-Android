package com.jeju.nanaland.util.daterangecalendar.timepicker
...
import com.jeju.nanaland.util.daterangecalendar.customviews.CustomTextView
...
class AwesomeTimePickerDialog(
    ...
    private fun initView() {
        ...
        val tvHeaderTitle: CustomTextView = findViewById(R.id.tvHeaderTitle)
