...
@Composable
fun RestaurantKeywordFilterDialog(
    ...
    val tmpSelectedKeywordList = remember { getRestaurantKeywordSelectionList() }
...
@OptIn(ExperimentalFoundationApi::class)
fun getRestaurantKeywordAnchoredDraggableState() = AnchoredDraggableState(
    ...
    updateAnchors(
        DraggableAnchors {
            AnchoredDraggableContentState.Open at TOTAL_SCREEN_HEIGHT - 468f - SYSTEM_STATUS_BAR_HEIGHT - SYSTEM_NAVIGATION_BAR_HEIGHT
