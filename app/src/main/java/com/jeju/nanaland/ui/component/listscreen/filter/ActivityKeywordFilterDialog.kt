...
@Composable
fun ActivityKeywordFilterDialog(
    ...
    val tmpSelectedKeywordList = remember { getActivityKeywordSelectionList() }
...
@OptIn(ExperimentalFoundationApi::class)
fun getActivityKeywordAnchoredDraggableState() = AnchoredDraggableState(
    ...
    updateAnchors(
        DraggableAnchors {
            AnchoredDraggableContentState.Open at TOTAL_SCREEN_HEIGHT - 328f - SYSTEM_STATUS_BAR_HEIGHT - SYSTEM_NAVIGATION_BAR_HEIGHT
